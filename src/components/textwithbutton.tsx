...
const TextWithButton = () => {
    return (
        <div className="flex flex-col items-center justify-center pt-20">
            ...
            <button className="px-10 py-5 pb-7  my-10 text-3xl mt-4 bg-gradient-to-r font-sans hover:from-green-500 hover:to-blue-500 from-green-600 to-blue-600 text-white rounded-md shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                تصفح كل البرامج
            </button>
        </div>
    );
